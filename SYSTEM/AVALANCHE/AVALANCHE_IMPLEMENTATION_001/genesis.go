...
func (g *Genesis) Validate() error {
	...
	wantOrigin := GenesisConstitutionOrigin{
		...
		44133, 146048,
		"EXACT_COMMIT_PATH_LENGTH_SHA256",
		"BYTE_IDENTICAL_EVIDENCE_NOT_SEPARATE_ORIGIN",
		"FORM_BINDING_NON_EFFECTS_APPLY",
	}
	if g.Constitution.HumanPath != "../../../../SOURCE/CONSTITUTION_0()1.md" || g.Constitution.HumanSHA256 != constitutionHumanSHA256 || g.Constitution.MachinePath != "../../../../SOURCE/CONSTITUTION_0()1.json" || g.Constitution.MachineSHA256 != constitutionMachineSHA256 || g.Constitution.PublicOrigin != wantOrigin || g.Constitution.HumanRole != "SUBSTANTIVE_MEANING" || g.Constitution.MachineRole != "REPRESENTATION_ONLY" || g.Constitution.ConflictResult != "UNRESOLVED_HOLD_EXACT_SCOPE" || g.Constitution.ParsingHasForce {
	...
	if g.Capacity.Unit != "LOCALITY_CAPACITY_UNIT" || g.Capacity.StructuralCeilingUnits == 0 || g.Capacity.InitialActualUnits > g.Capacity.StructuralCeilingUnits || g.Capacity.CorrectionEgressReserveUnits == 0 || g.Capacity.CorrectionEgressReserveUnits >= g.Capacity.StructuralCeilingUnits || g.Capacity.MaxAdmissionOfferSeconds <= 0 {
