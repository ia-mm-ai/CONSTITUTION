...
export const CONTINUITY_STEP_SCHEMA = "PRESENCE_PARTICIPANT_STATE_SUCCESSION_001";
export const CONTINUITY_PASSAGE_SCHEMA = "PRESENCE_PARTICIPANT_STATE_PASSAGE_001";
