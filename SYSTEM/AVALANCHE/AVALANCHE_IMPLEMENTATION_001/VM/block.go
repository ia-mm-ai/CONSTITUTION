...
func newGenesisBlock(vm *VM, genesisBytes []byte, state *RuntimeState) *presenceBlock {
...
func newWireBlock(vm *VM, wire *WireBlock, builtLocally bool) (*presenceBlock, error) {
...
func blockFromBytes(vm *VM, blockBytes []byte, status choices.Status) (*presenceBlock, error) {
...
func (b *presenceBlock) ID() ids.ID           { return b.id }
func (b *presenceBlock) Parent() ids.ID       { return b.parentID }
func (b *presenceBlock) Height() uint64       { return b.height }
func (b *presenceBlock) Timestamp() time.Time { return b.timestamp }
func (b *presenceBlock) Bytes() []byte        { return bytes.Clone(b.bytes) }
func (b *presenceBlock) Status() choices.Status {
	b.vm.lock.RLock()
	defer b.vm.lock.RUnlock()
	return b.status
}

func (b *presenceBlock) Verify(context.Context) error {
	if b.genesis {
		return nil
	}
...
func (b *presenceBlock) Accept(context.Context) error {
	if b.genesis {
		return nil
	}
...
func (b *presenceBlock) Reject(context.Context) error {
	if b.genesis {
