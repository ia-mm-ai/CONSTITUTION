...
func testGenesis(t *testing.T) ([]byte, *Genesis, testAuthorities) {
	...
	genesis := &Genesis{
		...
		Domain: GenesisDomain{
			ID:             domainID,
			GenesisID:      "PRESENCE-RUNTIME-TEST-001",
			...
			Purpose:        "Exercise the PRESENCE AVALANCHE executable grammar.",
		},
		...
		Constitution: GenesisConstitution{
			...
			FormBindingPath: "SYSTEM/AVALANCHE/AVALANCHE_IMPLEMENTATION_001/binding/FORM_BINDING.json", FormBindingSHA256: constitutionBindingSHA256,
			PublicOrigin: GenesisConstitutionOrigin{
				...
				FormBindingRepositoryPath: "SYSTEM/AVALANCHE/AVALANCHE_IMPLEMENTATION_001/binding/FORM_BINDING.json",
				HumanBytes:                44133, MachineBytes: 146048, FormBindingBytes: 1939,
