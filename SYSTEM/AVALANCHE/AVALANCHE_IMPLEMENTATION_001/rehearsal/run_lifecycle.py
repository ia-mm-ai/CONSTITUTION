#!/usr/bin/env python3
"""Execute and verify LOCALITY REHEARSAL 003 without exporting private material."""
...
EMERGENCE_ID = "LOCALITY-REHEARSAL-EMERGENCE-003"
MEDIUM_CAPABILITIES = [
    "OBSERVE_CROSSING",
    "PRESENT_FORM",
    "GATE_DISPOSITION",
...
def continuity_successor(
    ...
    envelope = {
        "schema": "PRESENCE_AVALANCHE_PARTICIPANT_STATE_SUCCESSION_001",
...
def addressed_residue(addressed_to_locality_id: str) -> dict[str, Any]:
    ...
    return {
        "residue_id": hashlib.sha256(
            b"PRESENCE_AVALANCHE_RESIDUE_ID_001\x00" + envelope_bytes
        ).hexdigest(),
...
def load_public_authority(path: pathlib.Path) -> dict[str, Any]:
    ...
    expected = "PRESENCE_AVALANCHE_AUTHORITY_PUBLIC_001"
...
def command_run(args: argparse.Namespace) -> None:
    ...
    presentation = issue(
        ...
        {
            "locality_reference": "CONTINUITY-REHEARSAL-003",
    ...
    issue(
        ...
        args.host_private,
        {
            ...
            "purpose_sha256": digest("LOCALITY REHEARSAL 003 RETURN PURPOSE"),
            "closure_condition_sha256": digest(
                "LOCALITY REHEARSAL 003 RETURN CLOSURE"
            ),
            "capacity_ceiling_units": 500,
        },
        locus_id=RETURN_LOCUS_ID,
