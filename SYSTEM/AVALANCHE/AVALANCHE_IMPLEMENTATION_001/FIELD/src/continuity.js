...
// These two schema strings are PRESENCE_AVALANCHE_VM_001 wire constants for
// participant state succession. They are the protocol identifiers the VM itself
// hashes when it verifies a CHECKPOINT_DEPARTURE or REENTER passage, so the
// FIELD must reproduce them byte-for-byte to build a passage the VM will accept.
// "locality" here is the VM domain concept (a host locus), not a product
// identity; the FIELD carries no predecessor product identity.
export const CONTINUITY_STEP_SCHEMA = "LOCALITY_PARTICIPANT_STATE_SUCCESSION_003";
export const CONTINUITY_PASSAGE_SCHEMA = "LOCALITY_PARTICIPANT_STATE_PASSAGE_003";
